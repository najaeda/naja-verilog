...
TEST(NajaVerilogTest012, test0) {
  ...
  EXPECT_EQ("test0", test0->identifier_.name_);
  EXPECT_FALSE(test0->identifier_.escaped_);
  EXPECT_TRUE(test0->ports_.empty());
  auto test1 = constructor.modules_[1];
  EXPECT_EQ("test1", test1->identifier_.name_);
  EXPECT_FALSE(test1->identifier_.escaped_);
  EXPECT_TRUE(test1->ports_.empty());
  auto test2 = constructor.modules_[2];
  EXPECT_EQ("test2", test2->identifier_.name_);
  EXPECT_FALSE(test2->identifier_.escaped_);
  EXPECT_EQ(5, test2->ports_.size());
  EXPECT_EQ("i0", test2->ports_[0].identifier_.name_);
  EXPECT_EQ(Port::Direction::Input, test2->ports_[0].direction_);
  EXPECT_EQ("i1", test2->ports_[1].identifier_.name_);
  EXPECT_EQ(Port::Direction::Input, test2->ports_[1].direction_);
  EXPECT_EQ("o0", test2->ports_[2].identifier_.name_);
  EXPECT_EQ(Port::Direction::Output, test2->ports_[2].direction_);
  EXPECT_EQ("o1", test2->ports_[3].identifier_.name_);
  EXPECT_EQ(Port::Direction::Output, test2->ports_[3].direction_);
  EXPECT_EQ("io", test2->ports_[4].identifier_.name_);
  ...
  EXPECT_EQ("test3", test3->identifier_.name_);
  EXPECT_FALSE(test3->identifier_.escaped_);
  EXPECT_EQ(5, test3->ports_.size());
  EXPECT_EQ("i0", test3->ports_[0].identifier_.name_);
  EXPECT_EQ(Port::Direction::Input, test3->ports_[0].direction_);
  EXPECT_EQ("i1", test3->ports_[1].identifier_.name_);
  EXPECT_EQ(Port::Direction::Input, test3->ports_[1].direction_);
  EXPECT_EQ("o0", test3->ports_[2].identifier_.name_);
  EXPECT_EQ(Port::Direction::Output, test3->ports_[2].direction_);
  EXPECT_EQ("o1", test3->ports_[3].identifier_.name_);
  EXPECT_EQ(Port::Direction::Output, test3->ports_[3].direction_);
  EXPECT_EQ("io", test3->ports_[4].identifier_.name_);
  ...
  EXPECT_EQ("test4", test4->identifier_.name_);
  EXPECT_EQ(5, test4->ports_.size());
  EXPECT_EQ("i0", test4->ports_[0].identifier_.name_);
  EXPECT_EQ(Port::Direction::Input, test4->ports_[0].direction_);
  EXPECT_EQ("i1", test4->ports_[1].identifier_.name_);
  EXPECT_EQ(Port::Direction::Input, test4->ports_[1].direction_);
  EXPECT_EQ("o0", test4->ports_[2].identifier_.name_);
  EXPECT_EQ(Port::Direction::Output, test4->ports_[2].direction_);
  EXPECT_EQ("o1", test4->ports_[3].identifier_.name_);
  EXPECT_EQ(Port::Direction::Output, test4->ports_[3].direction_);
  EXPECT_EQ("io", test4->ports_[4].identifier_.name_);
  ...
  EXPECT_EQ("test5", test5->identifier_.name_);
  EXPECT_FALSE(test5->identifier_.escaped_);
  EXPECT_EQ("i0", test5->ports_[0].identifier_.name_);
  ...
  EXPECT_EQ("i1", test5->ports_[1].identifier_.name_);
  ...
  EXPECT_EQ("o0", test5->ports_[2].identifier_.name_);
  ...
  EXPECT_EQ("o1", test5->ports_[3].identifier_.name_);
  ...
  EXPECT_EQ("io", test5->ports_[4].identifier_.name_);
  EXPECT_FALSE(test5->ports_[4].identifier_.escaped_);
...
TEST(NajaVerilogTest012, test1) {
  ...
  EXPECT_EQ("test", module->identifier_.name_);
}
