...
TEST(NajaVerilogTest3, test0) {
  ...
  }
  {
    ...
    EXPECT_EQ("mod0",  static_cast<VerilogConstructorTest::ModuleInstance*>(test->instances_[0])->model_.name_);
    EXPECT_EQ("inst0", static_cast<VerilogConstructorTest::ModuleInstance*>(test->instances_[0])->identifier_.name_);
    EXPECT_EQ("mod0",  static_cast<VerilogConstructorTest::ModuleInstance*>(test->instances_[1])->model_.name_);
    EXPECT_EQ("inst1", static_cast<VerilogConstructorTest::ModuleInstance*>(test->instances_[1])->identifier_.name_);
    EXPECT_EQ("mod1",  static_cast<VerilogConstructorTest::ModuleInstance*>(test->instances_[2])->model_.name_);
    EXPECT_EQ("inst2", static_cast<VerilogConstructorTest::ModuleInstance*>(test->instances_[2])->identifier_.name_);
    EXPECT_EQ("mod1",  static_cast<VerilogConstructorTest::ModuleInstance*>(test->instances_[3])->model_.name_);
    EXPECT_EQ("inst3", static_cast<VerilogConstructorTest::ModuleInstance*>(test->instances_[3])->identifier_.name_);
    EXPECT_EQ("mod1",  static_cast<VerilogConstructorTest::ModuleInstance*>(test->instances_[4])->model_.name_);
    EXPECT_EQ("inst4", static_cast<VerilogConstructorTest::ModuleInstance*>(test->instances_[4])->identifier_.name_);
    EXPECT_EQ("mod1",  static_cast<VerilogConstructorTest::ModuleInstance*>(test->instances_[5])->model_.name_);
    EXPECT_EQ("inst5", static_cast<VerilogConstructorTest::ModuleInstance*>(test->instances_[5])->identifier_.name_);

    auto inst0 = dynamic_cast<VerilogConstructorTest::ModuleInstance*>(test->instances_[0]);
    ASSERT_NE(nullptr, inst0);
    ...
    auto inst1 = dynamic_cast<VerilogConstructorTest::ModuleInstance*>(test->instances_[1]);
    ...
    auto inst2 = dynamic_cast<VerilogConstructorTest::ModuleInstance*>(test->instances_[2]);
    ...
    auto inst3 = dynamic_cast<VerilogConstructorTest::ModuleInstance*>(test->instances_[3]);
    ASSERT_NE(nullptr, inst3);
    ...
    auto inst4 = dynamic_cast<VerilogConstructorTest::ModuleInstance*>(test->instances_[4]);
    ASSERT_NE(nullptr, inst4);
    ASSERT_EQ(2, inst4->orderedConnections_.size());
    EXPECT_EQ(0, inst4->orderedConnections_[0].portIndex_);
    ASSERT_EQ(
      VerilogConstructorTest::OrderedInstanceConnection::Type::EXPRESSION,
      inst4->orderedConnections_[0].value_.index());
    auto expression =
      std::get<VerilogConstructorTest::OrderedInstanceConnection::Type::EXPRESSION>(inst4->orderedConnections_[0].value_);
    ASSERT_TRUE(expression.valid_);  
    EXPECT_EQ(naja::verilog::Expression::Type::RANGEIDENTIFIER,
    ...
    EXPECT_EQ(
      VerilogConstructorTest::OrderedInstanceConnection::Type::EXPRESSION,
      inst4->orderedConnections_[1].value_.index());
    expression =
      std::get<VerilogConstructorTest::OrderedInstanceConnection::Type::EXPRESSION>(
        inst4->orderedConnections_[1].value_);
    ASSERT_TRUE(expression.valid_);
    ...
    ASSERT_EQ(
      VerilogConstructorTest::OrderedInstanceConnection::Type::EXPRESSION,
      inst5->orderedConnections_[0].value_.index());
    expression =
      std::get<VerilogConstructorTest::OrderedInstanceConnection::Type::EXPRESSION>(
        inst5->orderedConnections_[0].value_);
    ASSERT_TRUE(expression.valid_);
    EXPECT_EQ(naja::verilog::Expression::Type::RANGEIDENTIFIER,
      expression.value_.index());
    identifier =
